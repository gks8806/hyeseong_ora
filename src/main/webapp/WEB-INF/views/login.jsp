						...
						<ul class="app_list">
							...
							<li class="clear"><label for="id_lbl"
								...
								<div class="app_content">
									<input name="user_id" type="text" class="w100p" id="name_lbl" placeholder="아이디를 입력해주세요" />
								</div></li>
							<li class="clear"><label for="pwd_lbl"
								class="tit_lbl pilsoo_item">암호</label>
								<div class="app_content">
									<input name="user_pw" type="password" class="w100p" id="pwd_lbl" placeholder="암호를 입력해주세요" />
								</div></li>
							</li>
						</ul>
						<p class="btn_line">
