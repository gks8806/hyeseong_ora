      ...
      <div class="header_area box_inner clear">   
         ...
         <div class="header_cont">
            ...
            <ul class="gnb clear">
               ...
               <li><a href="/board/list?seachBoard=notice" class="openAll2">고객센터</a>
                    <div class="gnb_depth gnb_depth2_2">
                            <ul class="submenu_list">
                                <li><a href="/board/list?searchBoard=notice" class="nav-link">공지사항</a></li>
                            	<li><a href="/board/list?searchBoard=gallery" class="nav-link">갤러리</a></li>
                            </ul>
                        </div>
               </li>
